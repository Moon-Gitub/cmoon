...
class Empresa extends Model
{
    ...
    /** Cupo mensual base (sin créditos comprados). */
    public function cupoIaMensualBase(): int
    {
    ...
    {
        return $this->cupoIaMensualBase() + (int) $this->ia_creditos_extra;
    }
