        ...
        <nav class="flex-1 space-y-1 overflow-y-auto px-3 py-4 text-sm">
            ...
            @can('ordenes-compra.ver')
                <a href="{{ route('ordenes-compra.index') }}"
                   class="flex items-center gap-3 rounded-lg px-3 py-2 {{ request()->routeIs('ordenes-compra.*') ? 'bg-indigo-600 text-white' : 'hover:bg-slate-800' }}">
            ...
            @can('remitos.ver')
                <a href="{{ route('remitos.index') }}"
                   class="flex items-center gap-3 rounded-lg px-3 py-2 {{ request()->routeIs('remitos.*') ? 'bg-indigo-600 text-white' : 'hover:bg-slate-800' }}">
            ...
            @can('cobranzas.ver')
                <a href="{{ route('cobranzas.index') }}"
                   class="flex items-center gap-3 rounded-lg px-3 py-2 {{ request()->routeIs('cobranzas.*') ? 'bg-indigo-600 text-white' : 'hover:bg-slate-800' }}">
            ...
            @can('cheques.ver')
                <a href="{{ route('cheques.index') }}"
                   class="flex items-center gap-3 rounded-lg px-3 py-2 {{ request()->routeIs('cheques.*') ? 'bg-indigo-600 text-white' : 'hover:bg-slate-800' }}">
            ...
            @can('crm.ver')
                <a href="{{ route('crm.index') }}"
                   class="flex items-center gap-3 rounded-lg px-3 py-2 {{ request()->routeIs('crm.*') ? 'bg-indigo-600 text-white' : 'hover:bg-slate-800' }}">
                    <svg class="h-5 w-5" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M3.75 12h16.5m-16.5 3.75h16.5M3.75 19.5h16.5M5.625 4.5h12.75a1.875 1.875 0 010 3.75H5.625a1.875 1.875 0 010-3.75z"/></svg>
                    CRM
                </a>
            @endcan
            ...
            @can('depositos.ver')
                <a href="{{ route('depositos.index') }}"
                   class="flex items-center gap-3 rounded-lg px-3 py-2 {{ request()->routeIs('depositos.*') ? 'bg-indigo-600 text-white' : 'hover:bg-slate-800' }}">
                    <svg class="h-5 w-5" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M20.25 7.5l-.625 10.632a2.25 2.25 0 01-2.247 2.118H6.622a2.25 2.25 0 01-2.247-2.118L3.75 7.5m8.25 3v6.75m0 0l-3-3m3 3l3-3M3.375 7.5h17.25c.621 0 1.125-.504 1.125-1.125v-1.5c0-.621-.504-1.125-1.125-1.125H3.375c-.621 0-1.125.504-1.125 1.125v1.5c0 .621.504 1.125 1.125 1.125z"/></svg>
                    Depósitos
                </a>
            @endcan
            ...
            @can('bancos.ver')
                <a href="{{ route('bancos.index') }}"
                   class="flex items-center gap-3 rounded-lg px-3 py-2 {{ request()->routeIs('bancos.*') ? 'bg-indigo-600 text-white' : 'hover:bg-slate-800' }}">
                    <svg class="h-5 w-5" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M12 21v-8.25M15.75 21v-8.25M8.25 21v-8.25M3 9l9-6 9 6m-1.5 12V10.332A48.36 48.36 0 0012 9.75c-2.551 0-5.056.2-7.5.582V21M3 21h18M12 6.75h.008v.008H12V6.75z"/></svg>
                    Bancos
                </a>
            @endcan

            @can('pos.vender')
                <a href="{{ route('mercadopago.visor') }}"
                   class="flex items-center gap-3 rounded-lg px-3 py-2 {{ request()->routeIs('mercadopago.*') ? 'bg-indigo-600 text-white' : 'hover:bg-slate-800' }}">
            ...
            @can('facturacion.ver')
                ...
                <a href="{{ route('facturas-recurrentes.index') }}"
                   class="flex items-center gap-3 rounded-lg px-3 py-2 {{ request()->routeIs('facturas-recurrentes.*') ? 'bg-indigo-600 text-white' : 'hover:bg-slate-800' }}">
                    <svg class="h-5 w-5" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0l3.181 3.183a8.25 8.25 0 0013.803-3.7M4.031 9.865a8.25 8.25 0 0113.803-3.7l3.181 3.182m0-4.991v4.99"/></svg>
    ...
    <div x-show="menuAbierto" x-cloak class="fixed inset-0 z-40 md:hidden" x-transition.opacity>
        ...
        <aside class="absolute left-0 top-0 flex h-full w-72 max-w-[85vw] flex-col bg-slate-900 text-slate-200 shadow-xl">
            ...
            <nav class="flex-1 space-y-1 overflow-y-auto px-3 py-4 text-sm">
                ...
                @can('facturacion.ver')
                    <a href="{{ route('facturacion.index') }}" class="block rounded-lg px-3 py-2 hover:bg-slate-800">Comprobantes</a>
                    <a href="{{ route('facturas-recurrentes.index') }}" class="block rounded-lg px-3 py-2 hover:bg-slate-800">Facturas recurrentes</a>
                @endcan
                @can('informes.ver')
